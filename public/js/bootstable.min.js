...
function FijModoNormal(t) {
 $(t).parent().find("#bAcep").hide(), $(t).parent().find("#bCanc").hide(), $(t).parent().find("#bEdit").show(), $(t).parent().find("#bElim").show(), $(t).parent().find("#bSave").show(), $(t).parents("tr").attr("id", "")
}

function FijModoEdit(t) {
 $(t).parent().find("#bAcep").show(), $(t).parent().find("#bCanc").show(), $(t).parent().find("#bEdit").hide(), $(t).parent().find("#bElim").hide(),$(t).parent().find("#bSave").hide(), $(t).parents("tr").attr("id", "editing")
}
...
function rowSave(t) {
 var n = $(t).parents("tr"),
  i = n.find("td");
sendDocument(i[0].innerHTML,i[1].innerHTML,i[2].innerHTML,i[3].innerHTML,i[4].innerHTML,i[5].innerHTML);
...
'</button>'+
'<button id="bSave" type="button" class="btn btn-sm btn-default" onclick="rowSave(this);">' +
...
$.fn.SetEditable = function(t) {
 ...
 params = $.extend(n, t), this.find("tbody tr").append(colEdicHtml), $tab_en_edic = this, null != params.$addButton && params.$addButton.click(function() {
  rowAgreg()
